...
def main(argv=None):  # pylint: disable=unused-argument
    ...
    # All instantiations of TensorFlow stuff had to be started within a tf.Session – being the instantiation of graph before anything could happen
...
if __name__ == '__main__':
    # https://www.machinecurve.com/index.php/2020/09/13/tensorflow-eager-execution-what-is-it/
